...
export const memSearchSchema = {
  ...
  limit: coerceInt.pipe(z.number().int().min(1).max(100)).optional().describe('Max results (default 5)'),
  offset: coerceInt.pipe(z.number().int().min(0)).optional().describe('Offset for pagination; use 5 for the next 5 results, then 10, etc.'),
