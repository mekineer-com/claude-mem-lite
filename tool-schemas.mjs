...
export const memSearchSchema = {
  ...
  limit: boundedInt(z.number().int().min(1).max(100)).optional().describe('Max results (default 5)'),
  offset: boundedInt(z.number().int().min(0))
    .optional()
    .describe('Offset for pagination; use 5 for the next 5 results, then 10, etc.'),
  sort: z
...
// `tools/list` (the original 6 + search feedback + mem_defer/mem_defer_list/mem_defer_drop). The
