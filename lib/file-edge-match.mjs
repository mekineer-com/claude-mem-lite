 ...
 * Module-private and the only copy in the repo — keep it that way. A second
 * copy is what produced the gap this replaced: the derivation existed twice,
 * the tests asserted the one that did not ship.
